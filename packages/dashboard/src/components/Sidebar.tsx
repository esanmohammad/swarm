    ...
    return (
      <div className="px-1 py-0.5">
        <button
          ...
          className={`flex items-center justify-center w-full p-2 rounded-md text-xs ${
            isGroupActive ? 'bg-stone-800/60 text-stone-200' : 'text-stone-600 hover:text-stone-400 hover:bg-stone-800/30'
          }`}
          title={group.label}
        >
  ...
  return (
    <div className="px-2">
      <button
        ...
        className="flex items-center gap-1 w-full px-1 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-stone-600 hover:text-stone-400 transition-colors"
      >
  ...
  return (
    <aside className={`${collapsed ? 'w-12' : 'w-52'} shrink-0 border-r border-stone-800/50 bg-[#0e0c0b] flex flex-col transition-all duration-200 overflow-hidden`}>
      ...
      <div className={`flex items-center ${collapsed ? 'justify-center' : 'justify-between'} px-3 py-3 border-b border-stone-800/40`}>
        {!collapsed && <span className="text-sm font-semibold tracking-wide text-stone-300">swarm</span>}
        <button
      ...
      <nav className="flex-1 overflow-y-auto py-2 space-y-0.5 scrollbar-thin">
        {/* Primary items */}
        <div className={`${collapsed ? 'px-1' : 'px-2'} space-y-0.5 pb-2 border-b border-stone-800/30 mb-2`}>
      ...
      {/* Footer */}
      {!collapsed && (
        <div className="px-3 py-2 border-t border-stone-800/40 text-[10px] text-stone-600">
